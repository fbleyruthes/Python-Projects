...
# Alunos: Francisco Bley Ruthes e Rafael Olivare Piveta
...
class Quadro(BoxLayout):
    ...
    def __init__ (self, *args, **dic):
        ...
        Window.size = (800,800)
        banco_de_palavras = ["cachorro","gato","flamengo","CaDeIRA","uvA","ÉpiCo","índice","motorista","político","faca","garfo","pão","brasil","pêndulo","arma","coração","amor","dúvida","kiwi","xícara","longe","ozônio","térmico","mesa","goleiro","fábrica","pneumonia","neologismo","física","programação","computador","código","estábulo","caminhão","penalidade","concerteza","imperatriz","zoológico"]
            ...
            if len(chute_usuario) == 1:
                ...
                for i in range(0,len(self.lista_palavra_aleatoria)):
                    if chute_usuario == v[i]:
                        ...
                        print(self.letras_já_selecionadas)
    ...
    def recomecaJogo(self):
        banco_de_palavras = ["cachorro","gato","flamengo","CaDeIRA","uvA","ÉpiCo","índice","motorista","político","comunismo","faca","garfo","pão","brasil","pêndulo","arma","coração","amor","dúvida","kiwi","xícara","longe","ozônio","térmico","mesa","goleiro","fábrica","xenofobia","pneumonia","neologismo","física","programação","computador","código","estábulo"]
        self.tentativas = 6
        self.ids.tentativas.text = str(self.tentativas)
